...
class AppIcons {
  ...
  static const mdvlLogoPath = '$basePath/mdvl_logo.png';
  static const appLogo = '$basePath/aashirwad_logo.svg';
  static const bpplLogoPath = '$basePath/bppl_revised_logo.png';

  static const mdvlLogo = AppIcon(mdvlLogoPath);
  static const htplLogo = AppIcon(appLogo);
  static const bpplLogo = AppIcon(bpplLogoPath);
...
class AppIcon {
  ...
  Widget toWidget({
    ...
    if(fileextension == '.svg') {
      return SvgPicture.asset(path, width: width, height: height, color: color, fit: fit); 
    }
