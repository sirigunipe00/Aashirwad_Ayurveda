...
import '../../features/dashboard/data/dashboard_repo_impl.dart' as _i64;
import '../../features/dashboard/presentation/bloc/bloc_provider.dart' as _i911;
import '../../features/dispatch_gaylord/data/dispatch_gaylord_repo.dart'
    as _i241;
import '../../features/dispatch_gaylord/data/dispatch_gaylord_repo_impl.dart'
    as _i676;
import '../../features/dispatch_gaylord/presentation/bloc/bloc_provider.dart'
    as _i967;
...
import '../../features/gate_exit/presentation/bloc/create_gate_exit/create_gate_exit_cubit.dart'
    as _i161;
import '../../features/gate_registration/data/gate_registration_repo.dart'
    as _i96;
import '../../features/gate_registration/data/gate_registration_repo_impl.dart'
    as _i565;
import '../../features/gate_registration/presentation/bloc/bloc_provider.dart'
    as _i909;
import '../../features/gate_registration/presentation/bloc/gate_registration/gate_registration_cubit.dart'
    as _i241;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i174.GetIt> init({
    ...
    gh.lazySingleton<_i876.DashboardRepo>(
        () => _i64.DashbaordRepoImpl(gh<_i351.ApiClient>()));
    ...
    gh.factory<_i911.DashboardBlocProvider>(
        () => _i911.DashboardBlocProvider(repo: gh<_i876.DashboardRepo>()));
    ...
    gh.lazySingleton<_i967.DispatchBlocProvider>(
        () => _i967.DispatchBlocProvider(gh<_i241.DispatchGaylordRepo>()));
    ...
    gh.lazySingleton<_i909.GateRegistrationBlocProvider>(() =>
        _i909.GateRegistrationBlocProvider(gh<_i96.GateRegistrationRepo>()));
    gh.factory<_i241.GateRegistrationCubit>(
        () => _i241.GateRegistrationCubit(gh<_i96.GateRegistrationRepo>()));
    return this;
  }
}
