...
import 'package:aashirwad/features/auth/data/auth_repo.dart';
import 'package:aashirwad/features/auth/model/logged_in_user.dart';
...
class AuthRepoImpl extends BaseApiRepository implements AuthRepo {
  ...
  String get _appName => AppConfig.appName;
}
