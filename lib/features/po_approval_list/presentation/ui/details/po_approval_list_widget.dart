            ...
            SpacedColumn(
              ...
              children: [
                Row(
                  ...
                  children: [
                    Text(poApproval.name, style: AppTextStyles.titleLarge(context).copyWith(color: AppColors.black)),
                    Text(DFU.ddMMyyyyFromStr(poApproval.creationDate), style: AppTextStyles.titleLarge(context).copyWith(color: AppColors.black)),
                  ],
                ),
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Expanded(child: Text(poApproval.vendorName, style: AppTextStyles.titleLarge(context).copyWith(color: AppColors.black))),
                    AppSpacer.p4(),
                    Text(DFU.timeLabelFromStr(poApproval.creationDate), style: AppTextStyles.titleLarge(context).copyWith(color: AppColors.black)),
                  ],
                ),
                AppSpacer.p8(),
                Row(
